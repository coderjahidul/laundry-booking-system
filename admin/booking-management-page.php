...
// Booking Return Management Page in Admin Dashboard
function booking_return_admin_menu(){
    add_menu_page(
        'Hour Booking Return Management', 
        'Hour Booking Return Management', 
        'manage_options', 
        'booking-return-management', 
        'booking_return_admin_page', 
        'dashicons-calendar-alt',
        20
    );
}
add_action('admin_menu', 'booking_return_admin_menu');
...
// Saver Booking Return Management Menu
function saver_booking_return_admin_menu() {
    add_menu_page(
        'Saver Booking Return Management', 
        'Saver Booking Return Management', 
        'manage_options', 
        'saver-booking-return-management', 
        'saver_booking_return_admin_page', // Correct function name
        'dashicons-calendar-alt',
        20
    );
}
add_action('admin_menu', 'saver_booking_return_admin_menu');

// Collection Booking Management Menu
function collection_admin_menu() {
    add_menu_page(
        ...
        'manage_options',
        'collection-booking-management',
        'collection_booking_admin_page', // Correct function name
        'dashicons-calendar-alt',
        20
    );
}
...
// Collection Booking Return Management Menu
function collection_return_admin_menu() {
    add_menu_page(
        'Collection Booking Return Management',
        'Collection Booking Return Management',
        'manage_options',
        'collection-booking-return-management',
        'collection_return_booking_admin_page', // Correct function name
        'dashicons-calendar-alt',
        20
    );
}
add_action('admin_menu', 'collection_return_admin_menu');
...
// Booking Return Management Page
function booking_return_admin_page() {
    ?>
    <div class="wrap booking-management">
        <h1 class="wp-heading-inline">Hour Booking Return Management</h1>
        ...
        if ($bookings->have_posts()) {
            ...
            while ($bookings->have_posts()) {
                $bookings->the_post();
                $date = get_post_meta(get_the_ID(), '_booking_return_date', true);
                $time_slot = get_post_meta(get_the_ID(), '_booking_return_time_slot', true);
                $status = get_post_meta(get_the_ID(), '_booking_return_status', true);
                $price = get_post_meta(get_the_ID(), '_booking_return_price', true);
...
// Saver Booking Return Management Page
function saver_booking_return_admin_page(){
    ?>
    <div class="wrap booking-management">
        <h1 class="wp-heading-inline">Saver Booking Return Management</h1>
        ...
        if (!empty($_POST['filter_date'])) {
            $meta_query[] = array(
                'key' => '_saver_booking_return_date',
                'value' => sanitize_text_field($_POST['filter_date']),
                'compare' => '=',
            );
        }
        ...
        if (!empty($_POST['filter_status'])) {
            $meta_query[] = array(
                'key' => '_saver_booking_return_status',
                'value' => sanitize_text_field($_POST['filter_status']),
                'compare' => '=',
            );
        }
        ...
        if ($bookings->have_posts()) {
            ...
            while ($bookings->have_posts()) {
                $bookings->the_post();
                $date = get_post_meta(get_the_ID(), '_saver_booking_return_date', true);
                $time_slot = get_post_meta(get_the_ID(), '_saver_booking_return_time_slot', true);
                $status = get_post_meta(get_the_ID(), '_saver_booking_return_status', true);
                $price = get_post_meta(get_the_ID(), '_saver_booking_return_price', true);
...
// Collection Booking Management Page
function collection_booking_admin_page() {
    ?>
    <div class="wrap booking-management">
        <h1 class="wp-heading-inline">Collection Booking Management</h1>
        ...
        if (!empty($_POST['filter_status'])) {
            $meta_query[] = array(
                'key' => '_collection_booking_status',
                'value' => sanitize_text_field($_POST['filter_status']),
                'compare' => '=',
            );
        }
        ...
        if ($bookings->have_posts()) {
            ...
            while ($bookings->have_posts()) {
                $bookings->the_post();
                $date = get_post_meta(get_the_ID(), '_collection_booking_date', true);
                $time_slot = get_post_meta(get_the_ID(), '_collection_booking_time_slot', true);
                $status = get_post_meta(get_the_ID(), '_collection_booking_status', true);
                $price = get_post_meta(get_the_ID(), '_collection_booking_price', true);
...
// Collection Booking Management Page
function collection_return_booking_admin_page() {
    ?>
    <div class="wrap booking-management">
        <h1 class="wp-heading-inline">Collection Booking Return Management</h1>
        ...
        if (!empty($_POST['filter_date'])) {
            $meta_query[] = array(
                'key' => '_collection_booking_return_date',
                'value' => sanitize_text_field($_POST['filter_date']),
                'compare' => '=',
            );
        }
        ...
        if (!empty($_POST['filter_status'])) {
            $meta_query[] = array(
                'key' => '_collection_booking_return_status',
                'value' => sanitize_text_field($_POST['filter_status']),
                'compare' => '=',
            );
        }
        ...
        if ($bookings->have_posts()) {
            ...
            while ($bookings->have_posts()) {
                $bookings->the_post();
                $date = get_post_meta(get_the_ID(), '_collection_booking_return_date', true);
                $time_slot = get_post_meta(get_the_ID(), '_collection_booking_return_time_slot', true);
                $status = get_post_meta(get_the_ID(), '_collection_booking_return_status', true);
                $price = get_post_meta(get_the_ID(), '_collection_booking_return_price', true);

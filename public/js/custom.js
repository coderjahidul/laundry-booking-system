jQuery(document).ready(function($){
    ...
    // Select return an address
    $('.select-return-address').on('click', function () {
        // Remove 'selected' class from all address cards
        $('.select-return-address').removeClass('selected');
        ...
        $.ajax({
            ...
            url: ajax_object.ajaxurl,
            data: {
                action: 'update_selected_return_address',
                post_id: postId,
            },
            success: function(response) {
                if (response.success) {
    ...
    $('.booking-return-slot-hour').on('click', function () {
        ...
        $.ajax({
            ...
            url: ajax_object.ajaxurl,
            data: {
                action: 'update_return_booking_slot',
                bookings_slot_id: bookingsSlotId,
                bookings_slot_date: bookingsSlotDate,
                bookings_slot_time: bookingsSlotTime,
                bookings_slot_price: bookingsSlotPrice,

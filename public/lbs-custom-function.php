        ...
        <div class="delevery-section tab-pane fade show active" id="delivery" role="tabpanel" aria-labelledby="delivery-tab">
            <div class="delivery-address">
                <div class="header">
                    ...
                    <div class="title">
                        <h3>The address where we will collect your laundry for cleaning.</h3>
                    </div>
                </div>
                ...
                <?php 
                    ...
                    if($bookings->have_posts()){
                        while($bookings->have_posts()){ 
                            ...
                            $collection_address = selected_address();
                            if($delivery_date == $bookings_slot_date){
                                if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                    ?>
                                        <div class="booking-slot booking-slot-hour available selected" data-bs-toggle="modal" data-bs-target="#cancelModal" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">Free</span><span class="loader-wrapper"></span></div>
                                    <?php
                                }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                    ?>
                                        <div class="booking-slot booking-slot-hour available selected" data-bs-toggle="modal" data-bs-target="#cancelModal" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
                                    <?php
                                    ...
                                    ?>
                                        <div class="booking-slot booking-slot-hour available" @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">Free</span><span class="loader-wrapper"></span></div>
                                    <?php
...
// hour return function
function hour_return_function(){
    ?>
    <div class="hour-section tab-pane fade show active" id="hour" role="tabpanel" aria-labelledby="hour-tab">
        <p class="text-center">Perfect if you need delivery within a 1 hour window. On the day, we’ll text you when the
            driver is close.</p>
                ...
                <?php 
                    ...
                    if ($bookings_date->have_posts()) {
                        while ($bookings_date->have_posts()) {
                            ...
                            $slot_date = get_post_meta(get_the_ID(), '_booking_return_date', true);
            ...
            <div class="row">
                ...
                <?php 
                    $args = array(
                        'post_type' => 'booking-return',
                        'posts_per_page' => -1, // Fetch all posts
                        'meta_key' => '_booking_return_time_slot',
                        'orderby' => 'meta_value',
                        'order' => 'ASC', // Ascending order for natural time order
                    );
                    ...
                    if ($bookings_time->have_posts()) {
                        while ($bookings_time->have_posts()) {
                            $bookings_time->the_post();
                            // Get the time slot
                            $time_slot = get_post_meta(get_the_ID(), '_booking_return_time_slot', true);
                    ...
                    <?php 
                        ...
                        if($bookings->have_posts()){
                            while($bookings->have_posts()){ 
                                ...
                                $bookings_slot_id = get_the_ID();
                                $user_id = get_current_user_id();
                                $bookings_slot_date = get_post_meta(get_the_ID(), '_booking_return_date', true);
                                $bookings_slot_status = get_post_meta(get_the_ID(), '_booking_return_status', true);
                                $bookings_slot_price = get_post_meta(get_the_ID(), '_booking_return_price', true);
                                $bookings_slot_time = get_post_meta(get_the_ID(), '_booking_return_time_slot', true);
                                $user_bookings_slot_id = get_user_meta($user_id, 'selected_return_booking_slot', true);

                                // Get selected booking slot post type where selected_booking_slot
                                $user_selected_slot_post_type = get_post_type(get_user_meta($user_id, 'selected_booking_slot', true));
                                ...
                                $return_address = selected_return_address();
                                if($delivery_date == $bookings_slot_date){
                                    if($user_selected_slot_post_type == 'booking'){
                                        if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                            ?>
                                                <div class="booking-slot booking-return-slot-hour available selected" data-bs-toggle="modal" data-bs-target="#cancelModal" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">Free</span><span class="loader-wrapper"></span></div>
                                            <?php
                                        }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                            ?>
                                                <div class="booking-slot booking-return-slot-hour available selected" data-bs-toggle="modal" data-bs-target="#cancelModal" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
                                            <?php
                                        }elseif($bookings_slot_status == 'fully_booked'){
                                            ?>
                                                <div class="booking-slot fully-booked" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Fully Booked</div>
                                            <?php
                                        }elseif($user_selected_slot_date_time >= $slot_date_time){
                                            ?>
                                                <div class="booking-slot unavailable" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Unavailable</div>
                                            <?php
                                        }elseif($bookings_slot_status == 'unavailable'){
                                            ?>
                                                <div class="booking-slot unavailable" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Unavailable</div>
                                            ...
                                            ?>
                                                <div class="booking-slot booking-return-slot-hour available" @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">Free</span><span class="loader-wrapper"></span></div>
                                            <?php
                                        }elseif($bookings_slot_status == 'available'){
                                            ?>
                                                <div class="booking-slot booking-return-slot-hour available"  @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
                                            <?php
                                        }
                                    }else{
                                        ?>
                    ...
                    if($bookings->have_posts()){
                        while($bookings->have_posts()){ 
                            ...
                            if($delivery_date == $bookings_slot_date){
                                if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                    ?>
                                        <div class="booking-slot booking-slot-saver available selected" data-bs-toggle="modal" data-bs-target="#cancelModalSaver" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">Free <br> <?php echo $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                    <?php
                                }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                    ?>
                                    ...
                                    ?>
                                        <div class="booking-slot booking-slot-saver available" @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">Free <br> <?php echo $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                    <?php
                                }elseif($bookings_slot_status == 'available'){
                                    ?>
                                        <div class="booking-slot booking-slot-saver available"  @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price . '<br>' . $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                ...
                <?php 
                    ...
                    if($bookings->have_posts()){
                        while($bookings->have_posts()){ 
                            ...
                            $return_address = selected_return_address();
                            if($delivery_date == $bookings_slot_date){
                                if($user_selected_slot_post_type == 'saver-booking'){
                                    if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                        ?>
                                            <div class="booking-slot booking-return-slot-saver available selected" data-bs-toggle="modal" data-bs-target="#cancelModalSaver" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">Free <br> <?php echo $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                        <?php
                                    }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                        ?>
                                            <div class="booking-slot booking-return-slot-saver available selected" data-bs-toggle="modal" data-bs-target="#cancelModalSaver" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price . '<br>' . $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                        <?php
                                    }elseif($bookings_slot_status == 'fully_booked'){
                                        ?>
                                            <div class="booking-slot fully-booked" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Fully Booked <br> <?php echo $bookings_slot_time;?></div>
                                        <?php
                                    }elseif($user_selected_slot_date_time >= $slot_date_time){
                                        ?>
                                            <div class="booking-slot unavailable" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Unavailable <br> <?php echo $bookings_slot_time;?></div>
                                        <?php
                                    }elseif($bookings_slot_status == 'unavailable'){
                                        ?>
                                            <div class="booking-slot unavailable" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>">Unavailable <br> <?php echo $bookings_slot_time;?></div>
                                        ...
                                        ?>
                                            <div class="booking-slot booking-return-slot-saver available" @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">Free <br> <?php echo $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                        <?php
                                    }elseif($bookings_slot_status == 'available'){
                                        ?>
                                            <div class="booking-slot booking-return-slot-saver available"  @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-return-address = "<?= $return_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price . '<br>' . $bookings_slot_time;?></span><span class="loader-wrapper"></span></div>
                                        <?php
                                    }
                                }else{
                                    ?>
                    ...
                    if($bookings->have_posts()){
                        while($bookings->have_posts()){ 
                            ...
                            if($delivery_date == $bookings_slot_date){
                                if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                    ?>
                                        <div class="booking-slot booking-slot-collection available selected" data-bs-toggle="modal" data-bs-target="#cancelModalCollection" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price"><i class="fa fa-check-circle" aria-hidden="true"></i></span><span class="loader-wrapper"></span></div>
                                    <?php
                                }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                    ?>
                                        <div class="booking-slot booking-slot-collection available selected" data-bs-toggle="modal" data-bs-target="#cancelModalCollection" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
                                    ...
                                    ?>
                                        <div class="booking-slot booking-slot-collection available" @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price"><i class="fa fa-check-circle" aria-hidden="true"></i></span><span class="loader-wrapper"></span></div>
                                    <?php
                                }elseif($bookings_slot_status == 'available'){
                                    ?>
                                        <div class="booking-slot booking-slot-collection available"  @click="open = true" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
...
function collection_return_function(){
    ?>
    <div class="collection-section tab-pane fade show active" id="hour" role="tabpanel" aria-labelledby="hour-tab">
        <div class="container my-4">
            <div class="d-flex justify-content-between">
                <?php 
                    ...
                    $args = array(
                        ...
                        'posts_per_page' => -1, // Get all bookings
                        'meta_key' => '_collection_booking_return_date',
                        'orderby' => 'meta_value',
                        'order' => 'ASC',
                    );
                    ...
                    if ($bookings_date->have_posts()) {
                        while ($bookings_date->have_posts()) {
                            ...
                            $slot_date = get_post_meta(get_the_ID(), '_collection_booking_return_date', true);
            ...
            <div class="row">
                ...
                <?php 
                    $args = array(
                        'post_type' => 'collection-return',
                        'posts_per_page' => -1, // Fetch all posts
                        'meta_key' => '_collection_booking_return_time_slot',
                        'orderby' => 'meta_value',
                        'order' => 'ASC', // Ascending order for natural time order
                    );
                    ...
                    if ($bookings_time->have_posts()) {
                        while ($bookings_time->have_posts()) {
                            $bookings_time->the_post();
                            // Get the time slot
                            $time_slot = get_post_meta(get_the_ID(), '_collection_booking_return_time_slot', true);
                    ...
                    <?php 
                        ...
                        if($bookings->have_posts()){
                            while($bookings->have_posts()){ 
                                ...
                                $bookings_slot_id = get_the_ID();
                                $user_id = get_current_user_id();
                                $bookings_slot_date = get_post_meta(get_the_ID(), '_collection_booking_return_date', true);
                                $bookings_slot_status = get_post_meta(get_the_ID(), '_collection_booking_return_status', true);
                                $bookings_slot_price = get_post_meta(get_the_ID(), '_collection_booking_return_price', true);
                                $bookings_slot_time = get_post_meta(get_the_ID(), '_collection_booking_return_time_slot', true);
                                $user_bookings_slot_id = get_user_meta($user_id, 'selected_return_booking_slot', true);
                                ...
                                if($delivery_date == $bookings_slot_date){
                                    if($user_selected_slot_post_type == 'collection'){
                                        if($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id && $bookings_slot_price == 0){
                                            ?>
                                                <div class="booking-slot booking-return-slot-collection available selected" data-bs-toggle="modal" data-bs-target="#cancelModalCollection" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price"><i class="fa fa-check-circle" aria-hidden="true"></i></span><span class="loader-wrapper"></span></div>
                                            <?php
                                        }elseif($bookings_slot_status == 'fully_booked' && $user_bookings_slot_id == $bookings_slot_id){
                                            ?>
                                                <div class="booking-slot booking-return-slot-collection available selected" data-bs-toggle="modal" data-bs-target="#cancelModalCollection" data-bookings-slot-id = "<?= $bookings_slot_id;?>" data-bookings-slot-date = "<?= $bookings_slot_date;?>" data-bookings-slot-status = "<?= $bookings_slot_status;?>" data-bookings-slot-price = "<?= $bookings_slot_price;?>" data-bookings-slot-time = "<?= $bookings_slot_time;?>" data-collection-address = "<?= $collection_address;?>"><span class="slot-price">£<?php echo $bookings_slot_price;?></span><span class="loader-wrapper"></span></div>
